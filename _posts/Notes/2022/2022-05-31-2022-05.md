...
普通漏洞在被**厂商发现**到**公开**有一段时间，但是对于 0day 漏洞，由于漏洞已经被描述或被利用，留给软/硬件供应商来准备补丁的时间只有“零天”。
...
[linux内存管理之PAE（物理地址扩展）解决内存大于4G的问题_linux超过4g的ddr怎么寻址-CSDN博客](https://blog.csdn.net/jinking01/article/details/105834801)
